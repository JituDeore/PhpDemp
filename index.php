...
<div class="container-fluid">
 ...
 <div class="col-sm-3">
    	...
    	<div class="panel panel-default">
         	<div class="panel-heading">Ad 1</div>
         	<div class="panel-body">Ad content Here.</div>
        </div>
        <hr>
        <div class="panel panel-default">
         	<div class="panel-heading">Ad 2</div>
         	<div class="panel-body">Ad content Here.</div>
        </div>
        <hr>
        <div class="panel panel-default">
         	<div class="panel-heading">Ad 3</div>
         	<div class="panel-body">Ad content Here.</div>
        </div>
        <hr>
		 </div>
 ...
 <!--/left-->
  ...
  <tr>
    ...
    <td><input type="text" name="contact" value="" class="form-control" required /></td>
  </tr>
  <tr>
